<?php $__env->startSection('pageClass', 'home'); ?>
<?php $__env->startSection('tabTitle', 'ArdhanFah - About'); ?>
<?php $__env->startSection('content'); ?>

<section class="home__section home__section--cityscape section blah-blah-blah">
    <h1>Hi, I'm Ardhan Dikri.</h1>
    <h2>a Student</h2>
    ...
    <div class="inside-container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <p class="tighter" style="text-align: center;">I'm a Student in SMK Negeri 1 Gedangan. Now, i'm 16 Years Old, i was attracted in World IT since I was 10 Years Old.                    and a desire to continually improve my skills.</p>
            </div>
        </div>
        <hr>
        <h2>What I can do</h2>
